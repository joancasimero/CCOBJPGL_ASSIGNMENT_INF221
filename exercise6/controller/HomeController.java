...
public class HomeController implements Initializable {
    ...
    static BedroompinkLamp blampink = new BedroompinkLamp();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // ============== PINK BEDROOM LAMP==================//
        blampink.setProductName("Pink Bedroom Lamp");
        name4.setText(blampink.getProductName());

        blampink.setProductPrice(10.99);
        price4.setText(Double.toString(blampink.getProductPrice()));

        blampink.setProductImage("images/lamp4.jpg");
        Image BedroompinkLamp = new Image(blampink.getProductImage());
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(button1)) {
            ...
            blampink.setProductStatus(true);
