...
public class CheckoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        name4.setText(HomeController.blampink.getProductName());
        price4.setText(Double.toString(HomeController.blampink.getProductPrice()));
        Image BedroompinkLamp = new Image(HomeController.blampink.getProductImage());
        img4.setImage(BedroompinkLamp);
        ...
        if (HomeController.clamp.getProductStatus() || HomeController.blamp.getProductStatus() || HomeController.wlamp.getProductStatus() || HomeController.blampink.getProductStatus()) {
            ...
            Double.parseDouble(choicebox4.getValue()) * HomeController.blampink.getProductPrice();
        }
    ...
    public void computeTotal(ActionEvent event) {
        ...
        if (HomeController.blampink.getProductStatus()) {
            ...
            item4Amount = HomeController.blampink.getProductPrice() * qty;
